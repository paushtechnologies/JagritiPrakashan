import{r as s,j as e,B as a,I as N,P as B,S as g,T as S,C as E,u as P}from"./index-1hZ873J2.js";import{C as z}from"./ChevronLeft-BS_ebcA8.js";import{B as R}from"./BookCard-DEMCbXmM.js";import{S as M}from"./SEO-Bivr7LG5.js";import{C as T,a as W}from"./DialogContent-BwXBe0q6.js";import{A as _}from"./ArrowForwardIos-Btad6MMP.js";import"./Stack-CVASjxkB.js";import"./Dialog-D7_gvQye.js";const $=6e3,O=2e3;function q({books:i=[],bannerMode:x=!1,autoPlay:u=!0}){const[p,m]=s.useState(0),[h,C]=s.useState(u),[d,b]=s.useState(null),[w,j]=s.useState(null),[I,v]=s.useState(!1),y=typeof window<"u"&&window.matchMedia("(max-width:600px)").matches,f=x?1:4,r=Math.max(0,Math.ceil(i.length/f)-1);s.useEffect(()=>{if(!h||r===0)return;const o=setInterval(()=>{m(c=>c<r?c+1:0)},$);return()=>clearInterval(o)},[h,r,p]);const t=()=>{m(o=>o>0?o-1:r)},l=()=>{m(o=>o<r?o+1:0)},n=s.useMemo(()=>{if(!x||!i.length)return null;const o=i[p*f];return o?`/banners/${y&&o.bannerMobile||o.banner}`:null},[i,p,f,y,x]);s.useEffect(()=>{if(!n)return;if(!d){const c=new Image;c.src=n,c.onload=()=>{b(n)};return}if(n===d)return;const o=new Image;o.src=n,o.onload=()=>{j(n),v(!0),setTimeout(()=>{b(n),j(null),v(!1)},O)}},[n,d]);const k=7,A=Array.from({length:k});return e.jsxs(a,{sx:{position:"relative",overflow:"hidden"},children:[e.jsx("style",{children:`
          /* EXTRA SOFT EASING */
