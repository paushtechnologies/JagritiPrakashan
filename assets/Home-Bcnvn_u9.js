import{r as n,j as e,B as t,I as R,P as B,S as h,T as S,C as N,u as M}from"./index-DbrkeLs3.js";import{C as E}from"./ChevronLeft-D9p5g72e.js";import{B as z}from"./BookCard-BXLG_Xs5.js";import{C as T,a as $}from"./DialogContent-DPTNnUKS.js";import{A as O}from"./ArrowForwardIos-BYn2Nt3o.js";import"./Stack-BY73PP8G.js";import"./Dialog-CgG7nTEk.js";const P=6e3,W=2e3;function _({books:i=[],bannerMode:m=!1,autoPlay:u=!0}){const[f,x]=n.useState(0),[p,k]=n.useState(u),[c,g]=n.useState(null),[w,j]=n.useState(null),[C,v]=n.useState(!1),y=typeof window<"u"&&window.matchMedia("(max-width:600px)").matches,b=m?1:4,r=Math.max(0,Math.ceil(i.length/b)-1);n.useEffect(()=>{if(!p||r===0)return;const a=setInterval(()=>{x(d=>d<r?d+1:0)},P);return()=>clearInterval(a)},[p,r,f]);const s=()=>{x(a=>a>0?a-1:r)},l=()=>{x(a=>a<r?a+1:0)},o=n.useMemo(()=>{if(!m||!i.length)return null;const a=i[f*b];return a?`/banners/${y&&a.bannerMobile||a.banner}`:null},[i,f,b,y,m]);n.useEffect(()=>{if(!o)return;if(!c){const d=new Image;d.src=o,d.onload=()=>{g(o)};return}if(o===c)return;const a=new Image;a.src=o,a.onload=()=>{j(o),v(!0),setTimeout(()=>{g(o),j(null),v(!1)},W)}},[o,c]);const I=7,A=Array.from({length:I});return e.jsxs(t,{sx:{position:"relative",overflow:"hidden"},children:[e.jsx("style",{children:`
          /* EXTRA SOFT EASING */
