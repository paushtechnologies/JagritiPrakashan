import{r as n,j as e,B as t,I as R,P as B,S as h,T as S,C as N,u as E}from"./index-Dtws-oWy.js";import{C as M}from"./ChevronLeft-CPnu_4hH.js";import{B as z}from"./BookCard-L-7jJduo.js";import{S as T}from"./SEO-CPiBwAR3.js";import{C as $,a as O}from"./DialogContent-ci9kIWlQ.js";import{A as P}from"./ArrowForwardIos-ef8vdspO.js";import"./Stack-NVDzhrfK.js";import"./Dialog-C2BZJCpn.js";const W=6e3,_=2e3;function F({books:i=[],bannerMode:m=!1,autoPlay:b=!0}){const[f,x]=n.useState(0),[p,k]=n.useState(b),[c,g]=n.useState(null),[w,j]=n.useState(null),[C,v]=n.useState(!1),y=typeof window<"u"&&window.matchMedia("(max-width:600px)").matches,u=m?1:4,r=Math.max(0,Math.ceil(i.length/u)-1);n.useEffect(()=>{if(!p||r===0)return;const a=setInterval(()=>{x(d=>d<r?d+1:0)},W);return()=>clearInterval(a)},[p,r,f]);const s=()=>{x(a=>a>0?a-1:r)},l=()=>{x(a=>a<r?a+1:0)},o=n.useMemo(()=>{if(!m||!i.length)return null;const a=i[f*u];return a?`/banners/${y&&a.bannerMobile||a.banner}`:null},[i,f,u,y,m]);n.useEffect(()=>{if(!o)return;if(!c){const d=new Image;d.src=o,d.onload=()=>{g(o)};return}if(o===c)return;const a=new Image;a.src=o,a.onload=()=>{j(o),v(!0),setTimeout(()=>{g(o),j(null),v(!1)},_)}},[o,c]);const I=7,A=Array.from({length:I});return e.jsxs(t,{sx:{position:"relative",overflow:"hidden"},children:[e.jsx("style",{children:`
          /* EXTRA SOFT EASING */
